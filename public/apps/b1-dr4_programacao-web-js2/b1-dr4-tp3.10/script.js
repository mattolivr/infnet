...
/**
 * Aqui vou considerar que é só o nome sem o sobrenome, porque o enunciado não fala "nome completo" ou algo do tipo
 * Se fosse para ser os dois eu faria algo como (totalCaracteres += (f.nome.length + f.sobrenome.length))
 */
figurasHistoricas.forEach((f) => (totalCaracteres += f.nome.length));
