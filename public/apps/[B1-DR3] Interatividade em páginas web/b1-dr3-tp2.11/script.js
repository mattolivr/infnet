...
const segundaImagem = galeria.childNodes[1];
const navegacaoBody = segundaImagem.parentNode.parentNode;
const textoPrimeiroItemLista = navegacaoBody.lastChild.firstChild.textContent;

// alert(textoPrimeiroItemLista);

// 2.11

const primeiraImagem = body.querySelector("#galeria").firstElementChild;
alert(primeiraImagem.getAttribute("src"));
